...
mini_batch = 10
eta = 0.5
evaluation_cost_01, evaluation_accuracy_01, training_cost_01, training_accuracy_01 = net.SGD(training_data[:trainingSample2], epochs, mini_batch, eta, lmbda = 0.1, evaluation_data=validation_data[:testSample2],  monitor_evaluation_accuracy=True,monitor_training_cost=True,monitor_evaluation_cost=True,monitor_training_accuracy= True)
...
evaluation_cost_1, evaluation_accuracy_1, training_cost_1, training_accuracy_1 = net.SGD(training_data[:trainingSample2], epochs, mini_batch, eta, lmbda = 1.0, evaluation_data=validation_data[:testSample2],  monitor_evaluation_accuracy=True,monitor_training_cost=True,monitor_evaluation_cost=True,monitor_training_accuracy= True)
# net.save( "filename.json")
...
evaluation_cost_10, evaluation_accuracy_10, training_cost_10, training_accuracy_10 = net.SGD(training_data[:trainingSample2], epochs, mini_batch, eta, lmbda = 10.0, evaluation_data=validation_data[:testSample2],  monitor_evaluation_accuracy=True,monitor_training_cost=True,monitor_evaluation_cost=True,monitor_training_accuracy= True)
# net.save( "filename.json")
